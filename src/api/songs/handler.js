...
class SongsHandler {
  ...
  async addSongHandler(request, reply) {
    ...
    const responseResult = reply.response(successResponse({ songId }, getConstAdd('Song')));
  ...
  async editSongByIdHandler(request, reply) {
    ...
    return reply.response(successResponse(undefined, getConstUpdate('Song')));
  }
  ...
  async deleteSongByIdHandler(request, reply) {
    ...
    return reply.response(successResponse(undefined, getConstDelete('Song')));
  }
}
