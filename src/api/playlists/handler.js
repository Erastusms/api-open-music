...
class PlaylistsHandler {
  ...
  async addPlaylistHandler(request, reply) {
    ...
    const responseResult = reply.response(successResponse({ playlistId }, 'Playlist berhasil ditambahkan'));
  ...
  async deletePlaylistHandler(request, reply) {
    ...
    return reply.response(successResponse(undefined, 'Playlist berhasil dihapus'));
  }
  ...
  async addSongToPlaylistHandler(request, reply) {
    ...
    const responseResult = reply.response(successResponse(undefined, 'Song berhasil ditambahkan ke dalam Playlist'));
    return responseResult.code(201);
  }
  ...
  async deleteSongFromPlaylistHandler(request, reply) {
    ...
    return reply.response(successResponse(undefined, 'Playlist Song berhasil dihapus'));
  }
